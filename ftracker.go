...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	result := ((runningCaloriesMeanSpeedMultiplier * meanSpeed(action, duration) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	result := ((walkingCaloriesWeightMultiplier*weight + (math.Pow((meanSpeed(action, duration)*kmhInMsec), 2)/(height/cmInM))*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	result := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) *
